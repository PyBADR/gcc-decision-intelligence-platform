...
from src.api.v1.risk import router as v1_risk_router
from src.api.v1.portfolio import router as v1_portfolio_router
from src.api.v1.underwriting import router as v1_underwriting_router
from src.macro_intelligence.api.macro_routes import router as v1_macro_router
from src.api.v1.unified_decision.decision_routes import router as v1_unified_decision_router
from src.api.v1.audit.routes import router as v1_audit_router
from src.api.v1.policy.routes import router as v1_policy_router
...
async def lifespan(app: FastAPI):
    ...
    # Policy engine seed (idempotent — safe to run every startup)
    try:
        from src.core.policy.registry import seed_default_policies
        seed_result = seed_default_policies()
        print(f"📋 Policy Engine seeded: {seed_result['created']} created, "
              f"{seed_result['skipped']} skipped, {seed_result['total_rules']} rules")
    except Exception as e:
        print(f"⚠️  Policy seed skipped: {e}")
...
api_v1.include_router(v1_risk_router)
api_v1.include_router(v1_portfolio_router)
api_v1.include_router(v1_underwriting_router)
api_v1.include_router(v1_macro_router)
api_v1.include_router(v1_unified_decision_router)
api_v1.include_router(v1_audit_router)
api_v1.include_router(v1_policy_router)
